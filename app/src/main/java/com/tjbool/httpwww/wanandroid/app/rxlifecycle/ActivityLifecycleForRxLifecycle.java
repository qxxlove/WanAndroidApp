 ...
 */
package com.tjbool.httpwww.wanandroid.app.rxlifecycle;
...
/**
 * description: 配合 {@link ActivityLifecycleable} 使用,
 *              使 {@link Activity} 具有 {@link RxLifecycle} 的特性
 * autour: TMM
...
public class ActivityLifecycleForRxLifecycle implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
        if (activity instanceof ActivityLifecycleable) {
            ...
            /**同时注册FragmentLifecycleCallBack 事件*/
            if (activity instanceof FragmentActivity) {
                ((FragmentActivity) activity).getSupportFragmentManager()
                        .registerFragmentLifecycleCallbacks(mFragmentLifecycle.get(),
                                true);
            }
        }
    }
    ...
    /**
     * 从 {@link com.tjbool.httpwww.wanandroid.app.baseBaseActivity} 中获得桥梁对象
     *      {@code BehaviorSubject<ActivityEvent> mLifecycleSubject}
     *
